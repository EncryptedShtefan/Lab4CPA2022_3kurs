...
Window {
    ...
    Button {
        ...
        width: 100
        onClicked: {
            var nameGame = gameList.currentItem.gameData.NameOfGame
            var platformGame = gameList.currentItem.gameData.PlatformOfGame
            var creatorGame = gameList.currentItem.gameData.CreatorOfGame
            var genreGame = gameList.currentItem.gameData.GenreOfGame
            var index = gameList.currentItem.gameData.Id

            windowAddEdit.execute(nameGame, platformGame, creatorGame, genreGame,index)
        }
    }
    ComboBox
       {
