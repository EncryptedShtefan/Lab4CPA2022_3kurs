#ifndef SQLCONNECTIONEST_H
#define SQLCONNECTIONEST_H

#include <QtSql>
#include <QSqlDatabase>

class SqlConnectionEst : public QSqlQueryModel
{
    Q_OBJECT
...
public:
    explicit SqlConnectionEst(QObject* parent);
